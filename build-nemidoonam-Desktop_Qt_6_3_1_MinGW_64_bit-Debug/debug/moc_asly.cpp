...
struct qt_meta_stringdata_asly_t {
    const uint offsetsAndSize[2];
    char stringdata0[5];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_asly_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_asly_t qt_meta_stringdata_asly = {
    {
...
static const uint qt_meta_data_asly[] = {
...
const QMetaObject asly::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_asly.offsetsAndSize,
    qt_meta_data_asly,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_asly_t
...
void *asly::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_asly.stringdata0))
